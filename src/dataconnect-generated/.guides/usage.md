...
Here's an example:
```
import { injectListMovies, injectListUsers, injectListUserReviews, injectGetMovieById, injectSearchMovie, injectCreateMovie, injectUpsertUser, injectAddReview, injectDeleteReview } from '@dataconnect/generated/angular';
